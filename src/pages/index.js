	...
	if (!landed) {
		return (
			<section className="bg-[#FFF8F7] min-h-screen pt-[137px] text-center">
				...
				<button
					className="px-8 py-4 bg-[#F05736] rounded-md text-white font-NeueBold  my-6 "
					onClick={() => {
						setLanded(true);
					}}
				>
		...
		<>
			...
			<main>
				...
				<section className="min-h-screen flex items-center justify-center bg-[#FFF8F7]">
					<div className="grid lg:grid-cols-2  w-10/12 mx-auto mt-12">
						<article className="mb-10">
							<h1 className=" font-NeueBold text-[#0A4C73] text-3xl sm:text-4xl md:text-5xl ">
				...
				<section className=" w-10/12 mx-auto">
					...
					<p className="text-sm font-NeueLight text-center mb-12">
						Subscribe. Receive. Save up to 75% of losses. Activate
					</p>
					<ul className="grid md:grid-cols-2 lg:grid-cols-4 gap-[30px] ">
						<li className="flex flex-col items-center text-center p-8 shadow-lg w-10/12 md:w-full mx-auto">
							<figure>
						...
						<li className="flex flex-col items-center text-center px-6 py-8 w-10/12 md:w-full mx-auto">
							<figure>
						...
						<li className="flex flex-col items-center text-center  py-8 w-10/12 md:w-full mx-auto">
							<figure>
							...
							<p className="font-NeueLight text-sm">
								Save up to 75% of losses, gain real-time insights into your
								smart grid.
							</p>
						</li>
						<li className="flex flex-col items-center text-center px-5 py-8 w-10/12 md:w-full mx-auto">
							<figure>
				...
				<section className="w-10/12 mx-auto mb-[105px]  ">
					...
					<ul className="grid md:grid-cols-2 lg:grid-cols-3 gap-8 mt-[85px]">
						<li className="text-center p-8 shadow-lgw-10/12 md:w-full mx-auto">
							<h3 className="text-2xl font-NeueBold mb-6">Comprehensiveness</h3>
							<p className="text-sm font-NeueLight">
								Pylon caters to the unique needs of emerging markets, covering
								all aspects of loss reduction, load management and revenue
								collection.
							</p>
						</li>
						<li className="text-center py-8 px-5 w-10/12 md:w-full mx-auto">
							<h3 className="text-2xl font-NeueBold mb-6">Affordability</h3>
							<p className="text-sm font-NeueLight">
								We are pioneering a smart-meter-as-a-service solution that
								simplifies cost of deployment, operation and maintenance of
								smart metering solutions into a single recurring fee per meter,
				...
				<section className="w-10/12 mx-auto grid md:grid-cols-2 gap-5  items-center mb-[104px] ">
					<article>
						...
						<p className="font-NeueLight text-xl my-6">
							We plessed collaborate with companies <br /> all size, from
							startup to famous brands.
						</p>
						<button className="px-8 py-4 bg-[#F05736] rounded-md text-white font-NeueBold">
							Request Demo
						</button>
